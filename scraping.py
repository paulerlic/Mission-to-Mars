...
def scrape_all():
    # Init headless driver for deploy
    ...
    # Run scraping functions and store results in a dict
    data = {
...
def mars_news(browser):
    ...
    try:
        ...
        # parent element to find first 'a' tag and save as 'news_title'
...
##end of return news title / paragraph
...
# List for imgs and titles
    hemisphere_image_urls = []
    #imgs_links= browser.find_by_css("a.product-item h3")

# Retrieve the img urls and titles 
    for i in range(4):      
    #create empty dict
        hemispheres = {}
